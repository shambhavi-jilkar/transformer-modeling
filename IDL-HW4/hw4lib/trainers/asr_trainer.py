...
class ASRTrainer(BaseTrainer):
    ...
    def _train_epoch(self, dataloader):
        ...
        for i, batch in enumerate(dataloader):
            ...
            with torch.autocast(device_type=self.device, dtype=torch.float16):
                ...
                # seq_out= seq_out.swapaxes(-1,-2)
                # TODO: Calculate CE loss
                ce_loss = self.ce_criterion(seq_out.reshape(-1,self.model.num_classes),targets_golden.flatten())
    ...
    def _validate_epoch(self, dataloader):
        ...
        recognition_config=self._get_evaluation_recognition_configs()
        config_name='greedy'
        config=recognition_config[config_name]
        # TODO: Call recognize
