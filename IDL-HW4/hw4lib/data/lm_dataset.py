...
class LMDataset(Dataset):
    ...
    def __init__(
        ...
        # Set up data paths 
        # Fix: Using 'root' directly without 'dataset' to match the config structure
        ...
        # Fix: Using config.get() with a proper default instead of config['dataset'].get()
        ...
        for file in tqdm(self.text_files):
            ...
            # Shifted: [SOS] + tokenized
            # Golden: tokenized + [EOS]
